...
; 32 custom function descriptors I (FIXED LENGTH = 15 chars).
    ...
    TCODE    .40,  .35,      "velocit�[m/min]"           ;041 velocity[m/min]
...
;
;licence:
    TCODE    .0,   .35,      "Questo programma �"        ;068 This program is
    TCODE    .0,   .65,      "distribuito nella"         ;069 distributed in the
    TCODE    .0,   .95,      "speranza che vi sar�"      ;070 hope that it will be
...
; 32 custom function descriptors II (FIXED LENGTH = 15 chars).
    ...
    TCODE    .40,   .35,     "GraficoVelocit�"           ;182 Graph. Velocity	(Show a graphical representation of the ascend speed)
...
;
    ...
    TCODE    .20,   .125,    "Profondit� Max:"           ;278 Max. Depth:
...
; Gaugemode description
    ...
    TCODE    .0,    .95,     "sar� Minuti:Secondi."      ;323 Minutes:Seconds.
    TCODE    .0,    .125,    "OSTC2 non calcoler�"       ;324 OSTC2 will not
...
; pSCR-GF mode description
    ...
    TCODE    .0,    .215,    "modalit� pSCR."    	 ;362 pSCR features.
;
; Setpoint Mode
