...
//
// Literature:
// B�hlmann, Albert: Tauchmedizin; 4. Auflage [2002];
...
static float 			var_N2_a;       // B�hlmann a, for current N2 tissue.
static float 			var_N2_b;       // B�hlmann b, for current N2 tissue.
static float 			var_He_a;       // B�hlmann a, for current He tissue.
static float 			var_He_b;       // B�hlmann b, for current He tissue.
...
void deco_calc_desaturation_time(void)
{
    ...
    N2_ratio = 0.7902; // FIXED sum as stated in b�hlmann
    pres_surface = int_I_pres_surface * 0.001;
